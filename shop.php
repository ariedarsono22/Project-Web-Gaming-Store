                        ...
                        <div class="main-menu">
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        <a class="active main-menu-link" href="shop.php">Shop</a>
            ...
            <div class="container">
                <div class="row">
                    <div
                        ...
                        <h3 class="breadcrumb-title"> Peripheral Gaming Store</h3>
                        <div class="breadcrumb-nav">
                            <nav aria-label="breadcrumb">
                                <ul>
                                    <li><a href="index.html">Home</a></li>
                                    <li><a href="shop-grid-sidebar-left.html">Shop</a></li>
                                    <li class="active" aria-current="page">Peripheral Gaming Store</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    ?>  
                                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                    ...
                                                    <div class="product-default-single border-around" data-aos="fade-up"
                                                        data-aos-delay="400">
                                                        <div class="product-img-warp"> <a href="details.php?id=<?php echo $listbarang['id_item']; ?>"
                                                                class="product-default-img-link">
                                                                <img src="admin/barang/foto_barang/<?php echo $listbarang['picture']; ?>"
                                                        ...
                                                        <div class="product-default-content">
                                                            <h6 class="product-default-link"><a href="details.php?id=<?php echo $listbarang['id_item']; ?>"><?php echo $listbarang['item_name']; ?></a></h6>
                                                            <span class="product-default-price">Rp <?php echo $listbarang['price']; ?></span>
                                                        </div>
